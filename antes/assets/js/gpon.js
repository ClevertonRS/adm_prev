  ...
  function renderUsers(users) {
    ...
    tbody.innerHTML = users.map(u => `
      <tr>
        ...
        <td><span class="badge-status ${u.nivel === 'admin' ? 'badge-nivel-admin' : u.nivel === 'backoffice' ? 'badge-nivel-backoffice' : 'badge-nivel-operador'}">${u.nivel === 'admin' ? 'Administrador' : u.nivel === 'backoffice' ? 'Backoffice' : 'Operador'}</span></td>
