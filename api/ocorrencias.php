...
{
    // Edição de ocorrência: antes desta correção, qualquer usuário logado (inclusive
    // operador/tecnico) podia editar qualquer campo sem checagem alguma de perfil.
    if (!gpon_user_has_role($user, ['admin', 'backoffice', 'supervisor'])) {
